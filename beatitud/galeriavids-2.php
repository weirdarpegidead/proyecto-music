          <?php
          /*
          Template Name: galeria de videos año anterior
          */
          ?>
          <?php get_header(); ?>
          <!-- galeria de videos -->
          <div class="row contenido galvids" data-equalizer>
            ...
            $the_query = new WP_Query( array( 'category_name' => 'videos','year'  => 2015, 'posts_per_page' => 6, 'paged' => $paged ) ); ?>
