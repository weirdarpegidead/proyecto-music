          ...
          */
          ...
          <div class="row contenido page">
            ...
            <?php query_posts('category_name=discos&posts_per_page=1' ); while ( have_posts() ) : the_post(); ?>
            <div class="large-12 columns">
              <div class="large-12 columns">
                <h3><?php the_title(); ?></h3>
              </div>
          ...
          <div class="row contenido page prox-event">
            ...
            <?php query_posts('category_name=discos&posts_per_page=6' ); while ( have_posts() ) : the_post(); ?>
