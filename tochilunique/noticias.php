          ...
          */
          ...
          <div class="row contenido page">
            ...
            <div class="large-12 columns">
              <h1 class="text-center"><span>Noticias </span>Tochilunique</h1>
              <div class="large-12 columns">
                <h3><?php the_title(); ?></h3>
              </div>
          ...
          <div class="row contenido page prox-event">
            <div class="large-12 columns text-center">
              <h1>Noticias <span>anteriores</span></h1>
            </div>
            <?php 
            $paged = ( get_query_var( 'paged' ) ) ? get_query_var( 'paged' ) : 1;
            $the_query = new WP_Query( array( 'category_name' => 'noticias','posts_per_page' => 6, 'paged' => $paged ) ); ?>
